...
from  odoo.addons.yummy_inventory_master_api.controllers.parser import Parser
from  odoo.addons.yummy_inventory_master_api.controllers.exceptions import QueryFormatError
